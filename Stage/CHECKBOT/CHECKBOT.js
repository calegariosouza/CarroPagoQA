...
(async () => {
    try {
        ...
        // Pesquisa o contato "Checkbot STAGE"
        const contactName = "CheckBot STAGE";
        await page.click('div[contenteditable="true"]');
        await page.type('div[contenteditable="true"]', contactName);
        await new Promise(resolve => setTimeout(resolve, 10000)); // Esperar a pesquisa
        await page.keyboard.press('Enter');
        await new Promise(resolve => setTimeout(resolve, 10000)); // Esperar contato abrir
        console.log(`[${getCurrentTime()}] Contato CheckBot STAGE encontrado com Sucesso!`);
